...
const SignUpScreen = ({ navigation }) => {
    ...
    const validateInputs = () => {
        ...
        if (!name) {
            setErrMessage('Name field Can\'t be Blank');
            setModalVisible(!modalvisible);
            return false;
        }
        if (!username) {
        ...
        <ImageBackground source={require('../../images/purpule-bg1.jpg')} style={styles.imageBackground} >
            <View style={styles.container}>
                ...
                <ActionCard style={styles.cardContainer}>
                    ...
                    <TextInput
                        name="account"
                        left={<TextInput.Icon name="account" color={Color.primary} />}
                        label="Enter Name"
                        value={name}
                        mode="flat"
                        dense={true}
                    ...
                    <TextInput
                        ...
                        keyboardType='default'
                    />
                    <Button mode='contained' loading={isLoading} onPress={signupHandler} style={styles.button} icon={'account-plus'}>signup</Button>
